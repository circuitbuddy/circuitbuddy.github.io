    ...
    parts: [
      {
        ...
        descriptionKey: 'circuit.multivibrator.part.led',
        shape: 'circle',
        x: 176,
        y: 218,
        radius: 51,
      ...
      },
      {
        ...
        descriptionKey: 'circuit.multivibrator.part.r22k',
        shape: 'rect',
        x: 352,
        y: 213,
        width: 45,
      ...
      },
      {
        ...
        imageUrl: COMPONENT_IMAGES.Resistors.r20k,
        descriptionKey: 'circuit.multivibrator.part.r330',
        shape: 'rect',
        x: 179,
        y: 370,
        width: 123,
      ...
      },
      {
        ...
        descriptionKey: 'circuit.multivibrator.part.capacitor',
        shape: 'circle',
        x: 352,
        y: 457,
        radius: 48,
      ...
      },
      {
        ...
        descriptionKey: 'circuit.multivibrator.part.transistor',
        shape: 'circle',
        x: 227,
        y: 551,
        radius: 50,
      ...
      },
      {
        ...
        descriptionKey: 'circuit.multivibrator.part.usbC',
        shape: 'rect',
        x: 440,
        y: 701,
        width: 162,
